...
function(e,t,n){for(var r in t)j(e,r,null,t[r],n)}(t,c,i),y(e,d,l),!w(t)&&(null!=t.text&&(""!==t.text?d.textContent=t.text:t.children=[n("#",void 0,void 0,t.text,void 0,void 0)]),null!=t.children)){var m=t.children;u(d,m,0,m.length,o,null,i),"select"===t.tag&&null!=c&&function(e,t){if("value"in t){if(null===t.value)-1!==e.dom.selectedIndex&&(e.dom.value=null);else{var n=""+t.value// eslint-disable-line no-implicit-coercion
...
function m(e,t,n,r,o,a){if(t!==n&&(null!=t||null!=n)){if(null==t||0===t.length)u(e,n,0,n.length,r,o,a);else if(null==n||0===n.length)b(e,t,0,t.length);else{var i=null!=t[0]&&null!=t[0].key,l=null!=n[0]&&null!=n[0].key,s=0,f=0;if(!i)for(;f<t.length&&null==t[f];)f++;if(!l)for(;s<n.length&&null==n[s];)s++;if(null===l&&null==i)return;// both lists are full of nulls
if(i!==l)b(e,t,f,t.length),u(e,n,s,n.length,r,o,a);else if(l){// bottom-up
for(// keyed diff
var d,m,y,w,k,S,E=t.length-1,j=n.length-1;E>=f&&j>=s&&(w=t[E],k=n[j],w.key===k.key);)w!==k&&p(e,w,k,r,o,a),null!=k.dom&&(o=k.dom),E--,j--;// top-down
for(;E>=f&&j>=s&&(m=t[f],y=n[s],m.key===y.key);)f++,s++,m!==y&&p(e,m,y,r,v(t,f,o),a);// swaps and list reversals
for(;E>=f&&j>=s&&s!==j&&m.key===k.key&&w.key===y.key;)g(e,w,S=v(t,f,o)),w!==y&&p(e,w,y,r,S,a),++s<=--j&&g(e,m,o),m!==k&&p(e,m,k,r,o,a),null!=k.dom&&(o=k.dom),f++,w=t[--E],k=n[j],m=t[f],y=n[s];// bottom up once again
for(;E>=f&&j>=s&&w.key===k.key;)w!==k&&p(e,w,k,r,o,a),null!=k.dom&&(o=k.dom),E--,j--,w=t[E],k=n[j];if(s>j)b(e,t,f,E+1);else if(f>E)u(e,n,s,j+1,r,o,a);else{// inspired by ivi https://github.com/ivijs/ivi/ by Boris Kaul
var d,O,T=o,C=j-s+1,N=Array(C),A=0,P=0,z=2147483647,I=0;for(P=0;P<C;P++)N[P]=-1;for(P=j;P>=s;P--){null==d&&(d=function(e,t,n){for(var r=Object.create(null);t<n;t++){var o=e[t];if(null!=o){var a=o.key;null!=a&&(r[a]=t)}}return r}(t,f,E+1));var L=d[(k=n[P]).key];null!=L&&(z=L<z?L:-1// becomes -1 if nodes were re-ordered
,N[P-s]=L,w=t[L],t[L]=null,w!==k&&p(e,w,k,r,o,a),null!=k.dom&&(o=k.dom),I++)}if(o=T,I!==E-f+1&&b(e,t,f,E+1),0===I)u(e,n,s,j+1,r,o,a);else if(-1===z)for(A=// the indices of the indices of the items that are part of the
...
e.attrs=t.attrs,e.children=t.children,e.text=t.text,!0}(r,t))return;if("string"==typeof v)switch(null!=r.attrs&&R(r.attrs,r,o),v){case"#":t.children.toString()!==r.children.toString()&&(t.dom.nodeValue=r.children),r.dom=t.dom;break;case"<":t.children!==r.children?(k(e,t),d(e,r,u,i)):(r.dom=t.dom,r.domSize=t.domSize,r.instance=t.instance);break;case"[":(function(e,t,n,r,o,a){m(e,t.children,n.children,r,o,a);var i=0,l=n.children;if(n.dom=null,null!=l){for(var s=0;s<l.length;s++){var u=l[s];null!=u&&null!=u.dom&&(null==n.dom&&(n.dom=u.dom),i+=u.domSize||1)}1!==i&&(n.domSize=i)}})(e,t,r,o,i,u);break;default:f=u,h=r.dom=t.dom,f=a(r)||f,"textarea"===r.tag&&(null==r.attrs&&(r.attrs={}),null!=r.text&&(r.attrs.value=r.text//FIXME handle multiple children
,r.text=void 0)),function(e,t,n,r){var o;if(null!=n)for(var a in n)j(e,a,t&&t[a],n[a],r);if(null!=t)for(var a in t)null!=(o=t[a])&&(null==n||null==n[a])&&function(e,t,n,r){if(!("key"===t||"is"===t||null==n||O(t))){if("o"!==t[0]||"n"!==t[1]||O(t)){if("style"===t)P(e.dom,n,null);else if(T(e,t,r)&&"className"!==t&&("value"!==t||"option"!==e.tag&&("select"!==e.tag||-1!==e.dom.selectedIndex||e.dom!==s()))&&("input"!==e.tag||"type"!==t))e.dom[t]=null;else{var o=t.indexOf(":");-1!==o&&(t=t.slice(o+1)),!1!==n&&e.dom.removeAttribute("className"===t?"class":t)}}else I(e,t,void 0)}}(e,a,o,r)}(r,t.attrs,r.attrs,f),w(r)||(null!=t.text&&null!=r.text&&""!==r.text?t.text.toString()!==r.text.toString()&&(t.dom.firstChild.nodeValue=r.text):(null!=t.text&&(t.children=[n("#",void 0,void 0,t.text,void 0,t.dom.firstChild)]),null!=r.text&&(r.children=[n("#",void 0,void 0,r.text,void 0,void 0)]),m(h,t.children,r.children,o,null,f)))}else(function(e,t,r,o,a,i){if(r.instance=n.normalize(l.call(r.state.view,r)),r.instance===r)throw Error("A view cannot return the vnode it received as argument");R(r.state,r,o),null!=r.attrs&&R(r.attrs,r,o),null!=r.instance?(null==t.instance?c(e,r.instance,o,i,a):p(e,t.instance,r.instance,o,a,i),r.dom=r.instance.dom,r.domSize=r.instance.domSize):null!=t.instance?(x(e,t.instance),r.dom=void 0,r.domSize=0):(r.dom=t.dom,r.domSize=t.domSize)})(e,t,r,o,i,u)}else x(e,t),c(e,r,o,u,i)}// Lifted from ivi https://github.com/ivijs/ivi/
...
!==t)&&t in e.dom}//style
var C=/[A-Z]/g;function N(e){return"-"+e.toLowerCase()}function A(e){return"-"===e[0]&&"-"===e[1]?e:"cssFloat"===e?"float":e.replace(C,N)}function P(e,t,n){if(t===n);else if(null==n)e.style.cssText="";else if("object"!=typeof n)e.style.cssText=n;else if(null==t||"object"!=typeof t)// Add new style properties
for(var r in // `old` is missing or a string, `style` is an object.
e.style.cssText="",n){var o=n[r];null!=o&&e.style.setProperty(A(r),String(o))}else{// Both old & new are (different) objects.
// Update style properties that have changed
for(var r in n){var o=n[r];null!=o&&(o=String(o))!==String(t[r])&&e.style.setProperty(A(r),o)}// Remove style properties that no longer exist
for(var r in t)null!=t[r]&&null==n[r]&&e.style.removeProperty(A(r))}}// Here's an explanation of how this works:
...
// 1 = scheduled
// 2 = done
for(;n<k.length;n++)if(k[n].check(a)){var o=k[n].component,i=k[n].route,l=o,u=h=function(i){if(u===h){if(i===g)return e(n+1);d=null!=i&&("function"==typeof i.view||"function"==typeof i)?i:"div",m=a.params,p=r,h=null,v=o.render?o:null,2===x?t.redraw():(x=2,t.redraw.sync())}};// There's no understating how much I *wish* I could
...
var e=[n(d,m.key,m)];return v&&(e=v.render(e[0])),e}}}))}return y.set=function(e,t,n){null!=h&&((n=n||{}).replace=!0),h=null,o(e,t,n)},y.get=function(){return p},y.prefix="#!",y.Link={view:function(e){var t,n,o=e.attrs.options,a={};u(a,e.attrs),// The first two are internal, but the rest are magic attributes
...
var a={},i={},l=o("iVcuU");l.trust=o("e2F9W"),l.fragment=o("7PZrX"),i=l;var s={},u=o("2uPnQ"),c=o("7EF0O");s=o("5y2KI")(window,u,c.redraw);var c=o("7EF0O"),f=function(){return i.apply(this,arguments)};f.m=i,f.trust=i.trust,f.fragment=i.fragment,f.mount=c.mount,f.route=o("4Ppi2"),f.render=o("j25vk"),f.redraw=c.redraw,f.request=s.request,f.jsonp=s.jsonp,f.parseQueryString=o("gZZfO"),f.buildQueryString=o("iRA82"),f.parsePathname=o("7lWrV"),f.buildPathname=o("cITMw"),f.vnode=o("dBs8J"),f.PromisePolyfill=o("k7iQv"),a=f;var d={},m={};function p(){}Object.defineProperty(m,"__esModule",{value:!0,configurable:!0}),Object.defineProperty(m,"default",{get:()=>h,set:void 0,enumerable:!0,configurable:!0});var h=function(e){function t(t){return new Proxy(p,{apply:(n,r,o)=>e(t,[],...o),get:(n,r)=>{let o=[r],a=new Proxy(p,{get:(e,t)=>(o.push(t),a),apply:(n,r,a)=>e(t,o,...a)});return a}})}return new Proxy(e=>t(e),{get:(e,n)=>t(e[n]||n)})},v=m&&m.__esModule?m:{default:m},g=function(e){return e.replace(/([A-Z])/g,function(e){return"-"+e[0].toLowerCase()})};d=function(e){return(0,v.default)(function(t,n){for(var r=arguments.length,o=Array(r>2?r-2:0),a=2;a<r;a++)o[a-2]=arguments[a];var i=n.map(g).join("."),l=i.length?[t,i].join(".").replace(".$","#"):t;return e.apply(void 0,[l].concat(o))})};// jshint esversion: 6
...
const{address:k,aside:S,footer:E,header:j,h1:O,h2:T,h3:C,h4:N,h5:A,h6:P,hgroup:z,main:I,nav:L,section:R,article:$,blockquote:_,dd:M,dir:U,div:F,dl:J,dt:D,figcaption:W,figure:Z,hr:H,li:q,ol:B,p:K,pre:Q,ul:V,a:X,abbr:G,b:Y,bdi:ee,bdo:et,br:en,cite:er,code:eo,data:ea,dfn:ei,em:el,i:es,kdm:eu,mark:ec,q:ef,rb:ed,rp:em,rt:ep,rtc:eh,ruby:ev,s:eg,samp:ey,small:ew,span:eb,strong:ex,sub:ek,sup:eS,time:eE,tt:ej,u:eO,wbr:eT,area:eC,audio:eN,img:eA,map:eP,track:ez,video:eI,embed:eL,iframe:eR,noembed:e$,object:e_,param:eM,picture:eU,source:eF,canvas:eJ,noscript:eD,script:eW,del:eZ,ins:eH,caption:eq,col:eB,colgroup:eK,table:eQ,tbody:eV,td:eX,tfoot:eG,th:eY,thead:e0,tr:e1,button:e2,datalist:e3,fieldset:e8,form:e4,formfield:e7,input:e9,label:e5,legend:e6,meter:te,optgroup:tt,option:tn,output:tr,progress:to,select:ta,textarea:ti,details:tl,dialog:ts,menu:tu,menuitem:tc,summary:tf,content:td,element:tm,slot:tp,template:th}=/*@__PURE__*/t(d)(/*@__PURE__*/t(a)),tv=(e=[])=>e[0],tg=(e=[])=>e[e.length-1],ty=(e,t)=>(e.push(t),e),tw=(e,t)=>e.indexOf(t)>=0,tb=(e,t)=>t(e),tx=e=>Math.round(100*e)/100,tk=JSON.parse(localStorage.getItem("data"))||{users:[],expenses:[],selectedStrategy:"largest bulk"};console.log(window.location.search);const tS=()=>(window.location.search=/*@__PURE__*/t(a).buildQueryString({data:btoa(encodeURIComponent(JSON.stringify(tk)).replace(/%([0-9A-F]{2})/g,function(e,t){return String.fromCharCode("0x"+t)}))}),!0),tE=()=>tk.users,tj=()=>tk.expenses,tO=()=>tS()&&localStorage.setItem("data",JSON.stringify(tk)),tT={name:""},tC=(e,t)=>-((e.user===t?-e.amount:0)+(tw(e.users,t)?e.amount/e.users.length:0)),tN=(e,t)=>tC(t,e)||0,tA=e=>tj().map(t=>tC(t,e)).reduce((e,t)=>e+t,0),tP=()=>tx(tj().map(e=>e.amount).reduce((e,t)=>e+t,0)),tz=()=>tE().map(e=>({user:e,sum:tA(e.name)})),tI=e=>(tE().push({name:e}),tO(),!0),tL=[{name:"simple",description:x(`The users are sorted by their sum of expenses. Starting with 
...
r.forEach((e,t)=>{0!==e.sum&&t<r.length-1&&(n.push({name:e.user.name,transactions:[{receiver:r[t+1].user.name,amount:e.sum}]}),r[t+1].sum+=e.sum)}),n)}},{name:"advanced",description:x(`The users are sorted by their sum of expenses. Starting with 
       the least amount, the users will pay the next user in the list 
       until the sum is 0. Note that this might potentially result in 
       large transactions.`),calculateTransactions:(e,t)=>{let n=[],r=tz().sort((e,t)=>e.sum<0&&t.sum>0||e.sum>0&&t.sum<0?e.sum-t.sum:t.sum-e.sum);return(//  result.push(startingPoint);
r.forEach((e,t)=>{0!==e.sum&&t<r.length-1&&(n.push({name:e.user.name,transactions:[{receiver:r[t+1].user.name,amount:e.sum}]}),r[t+1].sum+=e.sum)}),n)}},{name:"largest bulk",description:x(`We try to reduce the amount 
    ...
    e2.secondary({onclick:e=>tJ()},/*@__PURE__*/t(a).trust("&times;")),e2.tertiary({onclick:e=>{t$()}},"+")])]),H(),T(x("Split")),ta({value:tk.selectedStrategy,oninput:e=>tk.selectedStrategy=e.target.value},tL.map(e=>tn(e.name))),K(tR(tk.selectedStrategy).description),tk.selectedStrategy?tR(tk.selectedStrategy).calculateTransactions(tj(),tE()).map(e=>K(e.transactions.map(t=>F(Y(e.name)," ",x("pays")," ",Y(t.receiver)," ",ec(-tx(t.amount)),"",tk.currency)))):null,H(),F.container(F.row(F["col-md-2"](eb({class:"icon-share"}),x("Share the current state by copying this link.")),F["col-md-7 col-sm-12"](Q.overflowHidden.$linktext(window.location.href),x("The link will change with each change you make."),tD?F.toast(tD):null),F["col-md-3"](e2({onclick:e=>(function(e){if(tD="",document.selection){// IE
        var n=document.body.createTextRange();n.moveToElementText(document.getElementById(e)),n.select()}else if(window.getSelection){var n=document.createRange();n.selectNode(document.getElementById(e)),window.getSelection().removeAllRanges(),window.getSelection().addRange(n)}try{tD=document.execCommand("copy")?x("Copied!"):x("Unable to copy!")}catch(e){tD=x("Unsupported Browser!")}setTimeout(()=>{tD="",/*@__PURE__*/t(a).redraw()},2e3)})("linktext")},x("Select link")))))]});//# sourceMappingURL=index.a1041e38.js.map

//# sourceMappingURL=index.a1041e38.js.map
